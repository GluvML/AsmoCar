...
class GaugeRenderer {
    constructor() {
        ...
        this.colors = {
            co2: { main: '#10b981', glow: 'rgba(16, 185, 129, 0.25)', gradient: ['#34d399', '#10b981'] },
            temp: { main: '#f59e0b', glow: 'rgba(245, 158, 11, 0.25)', gradient: ['#fbbf24', '#f59e0b'] },
            humidity: { main: '#38bdf8', glow: 'rgba(56, 189, 248, 0.25)', gradient: ['#7dd3fc', '#38bdf8'] }
        };
    }
    ...
    _getCo2Colors(value) {
        ...
        if (!window.DataManager) {
            return isLight
                ? { main: '#059669', glow: 'rgba(5, 150, 105, 0.15)', gradient: ['#10b981', '#059669'] }
                : { main: '#10b981', glow: 'rgba(16, 185, 129, 0.25)', gradient: ['#34d399', '#10b981'] };
        }
        ...
        if (value > t.co2.max) {
            ...
            return isLight
                ...
                : { main: '#f59e0b', glow: 'rgba(245, 158, 11, 0.25)', gradient: ['#fbbf24', '#f59e0b'] };
        } else {
            return isLight
                ? { main: '#059669', glow: 'rgba(5, 150, 105, 0.15)', gradient: ['#10b981', '#059669'] }
                : { main: '#10b981', glow: 'rgba(16, 185, 129, 0.25)', gradient: ['#34d399', '#10b981'] };
