...
const translations = {
    vi: {
        ...
        quality_monitoring: "Ngoài vùng {time} (chờ {target})",
        quality_alert_10m: "Cảnh báo ngoài vùng > {time}",
        metric_co2: "CO₂",
        ...
        alert_co2_above: "CO₂ vượt ngưỡng",
        alert_co2_below: "CO₂ dưới ngưỡng",
        alert_temp_above: "Nhiệt độ vượt ngưỡng",
        alert_temp_below: "Nhiệt độ dưới ngưỡng",
        alert_humidity_above: "Độ ẩm vượt ngưỡng",
        alert_humidity_below: "Độ ẩm dưới ngưỡng",
        alert_direction_above: "vượt",
        alert_direction_below: "dưới",
        alert_read: "Đã đọc",
        alert_unread: "Chưa đọc",
        alert_msg_format: "{car}: {metric} {direction} ngưỡng ({value} vs {threshold} {unit})",
        alert_msg_10m: "{car}: Chỉ số {metric} ngoài vùng an toàn hơn {time} ({value} {unit})",
        alert_toast_title: "Cảnh báo buồng lái",
        ...
        settings_alert_delay: "Độ trễ cảnh báo",
        alert_delay_10m: "10 phút",
        alert_delay_5m: "5 phút",
        alert_delay_3m: "3 phút",
        alert_delay_1m: "1 phút",
        alert_delay_0m: "Tức thì",
        ...
        settings_voice_alerts: "Âm thanh cảnh báo",
        settings_theme: "Chế độ nền",
        settings_vehicle_name: "Tên buồng lái",
        theme_light: "Sáng",
        settings_bluetooth: "Trạng thái kết nối",
        settings_hardware_desc: "",
        bluetooth_status_label: "Trạng thái",
        bluetooth_status_connected: "Đã kết nối ({device})",
        bluetooth_status_disconnected: "Chưa kết nối",
        bluetooth_btn_scan: "Tìm thiết bị",
        bluetooth_btn_disconnect: "Ngắt kết nối",
        bluetooth_modal_title: "Thiết bị khả dụng",
        bluetooth_scanning: "Đang tìm kiếm...",
        bluetooth_connecting: "Đang kết nối...",
        bluetooth_connect_success: "Đã kết nối Bluetooth thành công!",
        ...
        desc_co2_warning: "Nồng độ CO₂ hơi cao. Nên thông gió cabin hoặc lấy gió ngoài.",
    ...
    en: {
        ...
        quality_monitoring: "Out of range {time} (target {target})",
        quality_alert_10m: "Out-of-range alert > {time}",
        metric_co2: "CO₂",
        ...
        alert_msg_10m: "{car}: {metric} has been out of safe range for > {time} ({value} {unit})",
        alert_toast_title: "Cockpit Alert",
        ...
        settings_alert_delay: "Out-of-range alert delay",
        alert_delay_10m: "10 minutes (Default)",
        alert_delay_5m: "5 minutes",
        alert_delay_3m: "3 minutes",
        alert_delay_1m: "1 minute",
        alert_delay_0m: "Immediate (Test mode)",
        ...
        settings_voice_alerts: "Sound Alerts",
        settings_theme: "Theme Mode",
        settings_vehicle_name: "Cockpit Name",
        theme_light: "Light",
        theme_dark: "Dark",
        settings_bluetooth: "Connection Status",
        settings_hardware_desc: "",
        bluetooth_status_label: "Status",
        bluetooth_status_connected: "Connected ({device})",
        bluetooth_status_disconnected: "Disconnected",
        bluetooth_btn_scan: "Scan Devices",
        bluetooth_btn_disconnect: "Disconnect",
        bluetooth_modal_title: "Available Devices",
        bluetooth_scanning: "Scanning...",
        bluetooth_connecting: "Connecting...",
        bluetooth_connect_success: "Bluetooth connected successfully!",
        ...
        desc_co2_warning: "CO₂ levels are slightly elevated. Consider ventilating the cabin.",
    ...
    zh: {
        ...
        quality_danger: "危险警告!",
        quality_monitoring: "超出范围 {time} (预设 {target})",
        quality_alert_10m: "超标警报 > {time}",
        metric_co2: "CO₂",
        metric_temp: "温度",
        metric_humidity: "湿度",
        last_update: "更新时间",
        ...
        alert_msg_10m: "{car}: {metric} 超标已超过 {time} ({value} {unit})",
        alert_toast_title: "座舱环境警报",
        time_just_now: "刚刚",
        ...
        settings_alert_delay: "超标持续报警时间",
        alert_delay_10m: "10分钟 (默认)",
        alert_delay_5m: "5分钟",
        alert_delay_3m: "3分钟",
        alert_delay_1m: "1分钟",
        alert_delay_0m: "立即 (测试模式)",
        ...
        settings_voice_alerts: "声音警报",
        settings_theme: "背景模式",
        settings_vehicle_name: "座舱标识",
        theme_light: "明亮",
        theme_dark: "暗黑",
        settings_bluetooth: "连接状态",
        settings_hardware_desc: "",
        bluetooth_status_label: "状态",
        bluetooth_status_connected: "已连接 ({device})",
        bluetooth_status_disconnected: "未连接",
        bluetooth_btn_scan: "搜索设备",
        bluetooth_btn_disconnect: "断开连接",
        bluetooth_modal_title: "可用设备",
        bluetooth_scanning: "正在搜索...",
        bluetooth_connecting: "正在连接...",
        bluetooth_connect_success: "蓝牙连接成功!",
        ...
        desc_co2_warning: "CO₂浓度稍微偏高。建议开启外循环通风。",
